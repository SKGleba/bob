#ifndef __DEFS_FSM_H__
#define __DEFS_FSM_H__
...
//#define HEAP_UNUSE // no dynamic mem mgr code
    ...
    #define HEAP_ONINIT 0x10 // initialize heap on init(), with 32 HEAP_ONINIT*4-sized small blocks
#endif
